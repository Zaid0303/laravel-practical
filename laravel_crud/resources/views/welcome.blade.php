...
<body>
    ...
    <div class="container">
        ...
        <form action="http://127.0.0.1:8000" method="POST" class="form-group">
            @csrf
            <div class="row">
                <div class="mb-3 col">
            ...
            <div class="row">
                ...
                <div class="mb-3 col">
                    ...
                    <input type="password" name="password" class="form-control" id="exampleInputPassword1" value="{{old('passowrd')}}">
                    <span class="text-danger">
                        @error('password')
                        {{$message}}
                        @enderror
